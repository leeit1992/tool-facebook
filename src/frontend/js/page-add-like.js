...
(function($){
    "use strict";
    var ATL_ADD_LIKE = Backbone.View.extend({
        el : '#avt-page-like',

        formClassError : 'md-input-danger',

        events: {
            'submit #avt-form-like' : 'handleForm',
            'click .atl-manage-like-delete-js' : 'removeLike',
        ...
        handleLike: function( event ){
            var data = {
                formData: $('#avt-form-like', this.el).serialize()
            },
            self = this;
            altair_helpers.content_preloader_show();
            // Send to server handle.
            $.ajax({
                url: AVTDATA.SITE_URL + '/validate-like',
                type: "POST",
                data: data,
                success: function ( res ) {
                    ...
                    if( false === dataResult.status ) {
                        ...
                        window.location = location.href = AVTDATA.SITE_URL + '/edit-like/' + dataResult.id;
                    }
                }
            });
        },
        ...
        removeLike: function(e){
            ...
            UIkit.modal.confirm('Are you sure?', function(){ 
                var data = { id: dataID };
                $.post(AVTDATA.SITE_URL + '/delete-like', data, function(result) {
