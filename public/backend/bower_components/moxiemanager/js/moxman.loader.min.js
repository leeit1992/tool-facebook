    ...
    define(__moxman_Loader, [__moxman_util_Loader, __moxman_Env, __moxman_util_I18n], function (ResourceLoader, Env, I18n) {
        ...
        function loadAndRender(view) {
            return function (settings) {
                ...
                if (!moxman.ui) {
                    ResourceLoader.load({js:[Env.baseUrl + "/js/moxman.api.min.js", Env.baseUrl + "/api.php?action=language" + (settings.language ? "&code=" + settings.language : ""), Env.baseUrl + "/api.php?action=PluginJs"], css:[Env.baseUrl + "/skins/lightgray/skin" + (Env.ie7 ? ".ie7" : "") + ".min.css"]}, done)
                } else {
                    done()
                }
            }
