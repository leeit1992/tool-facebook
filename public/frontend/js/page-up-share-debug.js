    ...
    var PAGE_UP_SHARE = Backbone.View.extend({
        ...
        changePacket : function(){
            ...
            $.post(AVTDATA.SITE_URL + '/get-up-share', data, function(result) {
                ...
                $(".avt_share_numner").val(dataResult.speedTime);
        ...
        startAction : function(){
            ...
            $.post(AVTDATA.SITE_URL + '/update-count-using', data, function(result){
                    ...
                    $(".avt-total-token-check").attr('data-total', $(".avt_share_numner").val());
                    $(".avt-total-token-check").text($(".avt_share_numner").val() + ' Like ');
