...
{   
    ...
    public function render()
    {
        ...
        $role = isset( self::$args['roleId'] ) ? self::$args['roleId'] : '';
        if ($id) {
            // Get info bookin 
                ...
                <div class="uk-width-medium-1-1 uk-margin-top">
                    <form id="page-admin-price-booking-form" class="atl-intinerary">
                        <div class="md-card atl-form-tour atl-intinerary--item">
                            <?php 
                                View(
                                    'backend/mailbox/layout/detailbooking/tour.tpl',
                                    [ 
                                        'tour' => $tour
                                    ]
                                ); 
                        ...
                        <?php
                            if (!empty($listIntinerary)) {
                                View(
                                    'backend/mailbox/layout/detailbooking/intinerary.tpl', 
                                    [ 
                        ...
                        <?php
                            if (!empty($services)) {
                                View(
                                    'backend/mailbox/layout/detailbooking/services.tpl', 
                                    [ 
                                        'services' => $services,
                                        'mdAccomodation' => $mdAccomodation,
                                        'mdCruise' => $mdCruise,
