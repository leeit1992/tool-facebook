<div id="avt-page-buy-like">
    <form action="<?php echo url('/user-tool/validate-buy-like'); ?>" id="avt-form-buy-like" method="POST">
        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-large-7-10">
                <div class="md-card">
                    <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                        <h2 class="heading_b">
                            <span class="uk-text-truncate" style="color: white;">Mua gói like</span>
                        </h2>
                    </div>
...
<?php 
registerScrips( [ 'page-buy-like' => assets('frontend/js/page-buy-like-debug.js') ] );
