<div id="avt-page-buy-add-like">
    <form action="<?php echo url('/user-tool/validate-buy-add-like'); ?>" id="avt-form-buy-add-like" method="POST">
        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-large-7-10">
                <div class="md-card">
                    <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                        <h2 class="heading_b">
                            <span class="uk-text-truncate" style="color: white;">Mua gói tăng like</span>
                        </h2>
                    </div>
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            <div class="uk-width-medium-1-1">
                                <div class="uk-form-row">
                                    <label>Chọn gói tăng like</label>
                                    <select name="avt_buy_packet" data-md-selectize>
                                        <?php foreach ($listAddLike as $value): ?>
...
<?php 
registerScrips( [ 'page-buy-add-like' => assets('frontend/js/page-buy-add-like-debug.js') ] );
