<div id="avt-page-buy-comment">
    <form action="<?php echo url('/user-tool/validate-buy-comment'); ?>" id="avt-form-buy-comment" method="POST">
        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-large-7-10">
                <div class="md-card">
                    <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                        <h2 class="heading_b">
                            <span class="uk-text-truncate" style="color: white;">Mua gói COMMENT</span>
                        </h2>
                    </div>
                    <div class="user_content" data-uk-grid-margin>
                        <div class="uk-grid" data-uk-grid-margin="">
                            ...
                            <div class="uk-width-medium-1-2">
                                <div class="uk-form-row">
                                    <label>Tốc độ comment/Phút</label>
                ...
                <div class="md-card">
                    ...
                    <div class="md-card-content">
                        <table class="uk-table uk-table-condensed">
                            <thead>
                                <tr>
                                    <th class="uk-text-center uk-text-nowrap">Gói COMMENT</th>
...
<?php 
registerScrips( [ 'page-buy-comment' => assets('frontend/js/page-buy-comment-debug.js') ] );
