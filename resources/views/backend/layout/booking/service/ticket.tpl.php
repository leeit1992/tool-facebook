    ...
    ?>
        <tr <?php echo $titleTooltips; ?>>
            ...
            <td class="uk-text-middle">
                <?php 
                    echo isset($value['fromTo']) ? $value['fromTo'] : '';
                ?>
            </td>
            <td>
                <?php 
            ...
            <td class="uk-text-middle uk-text-nowrap uk-text-center">
                <?php if (isset($value['priceMain'])): ?>
                    <?php if ($value['price'] != $value['priceMain']): ?>
                        <a href="#" class="atl-action-price-booking" title="Accept" data-idInti="<?php echo isset($idInti) ? $idInti : ''; ?>" data-idBooking="<?php echo isset($idBooking) ? $idBooking : ''; ?>" data-serv="ticket" data-idkey="<?php echo $key; ?>" data-act="accept"><i class="material-icons md-24 uk-text-success">check</i></a>&nbsp &nbsp
                        <a href="#" class="atl-action-price-booking" title="Refuse" data-idInti="<?php echo isset($idInti) ? $idInti : ''; ?>" data-idBooking="<?php echo isset($idBooking) ? $idBooking : ''; ?>" data-serv="ticket" data-idkey="<?php echo $key; ?>" data-act="refuse"><i class="material-icons md-24 uk-text-danger">cancel</i></a>
                    <?php endif ?>
                <?php endif ?>
            </td>
        </tr>
